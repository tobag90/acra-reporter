...
public class FocusPoint {
  ...
  public void setBottomParentTrackPoint(FocusPoint parentFocusPoint) {
    if(this.parentFocusPoint == null)
    {
      this.parentFocusPoint = parentFocusPoint;
    }else
    {
      this.parentFocusPoint.setBottomParentTrackPoint(parentFocusPoint);
    }
  }
